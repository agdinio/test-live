  ...
  render() {
    return (
      <DDSelect
        ...
        onChange={this.props.countryCodeChange}
      >
...
const DDSelect = styled.select`
  width: 40%;
  height: ${props => responsiveDimension(7)};
  outline: none;
  border: none;
  border-top-left-radius: ${props => responsiveDimension(0.4)};
  border-bottom-left-radius: ${props => responsiveDimension(0.4)};
